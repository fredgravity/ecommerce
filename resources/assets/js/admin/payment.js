(function () {
    ...
    ARTISAOSTORE.admin.payment = function () {
        chart();
        ...
        let app = new Vue({
            ...
            data: {
                convertAmt: '',
                amountGHC: $('#user-payment-cedis').val()
            ...
            methods: {
                convert: function () {
                    ...
                    axios.post('/admin/users/payments/converter', postData).then(function (response) {
    ...
    function chart() {
        ...
        const paymentCanvas = $("#totalPayments");

        //CREATE LABELS FOR THE PAYMENT CHART
        let amount = [];
        let date = [];

        axios.get('/admin/payments/chart').then(function (response) {
