    ...
    <form action="">
        <div class="row">
            <div class=" " id="shopping_cart">
                ...
                +233<input type="text" name="phone" id="phone" value="<?php echo e(user()->phone); ?>">

                            <div class="expanded button-group">
                                <div >
                                    <button class="button primary" @click="myipay_btn" id="myipay-btn" data-token="<?php echo e(\App\Classes\CSRFToken::generate()); ?>">Pay</button>
                                </div>
                            </div>
