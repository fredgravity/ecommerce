...
<head>
    <meta charset="UTF-8">
    <title>User Panel - <?php echo $__env->yieldContent('title'); ?></title>
...
<div id="hide-div" style="display: none">
    <?php echo $__env->make('includes.user-sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
