<?php $__env->startSection('title', 'Vendor Create Product'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="add-product admin_shared grid-container full">
        ...
        <form action="/vendor/<?php echo e($user->id); ?>/product/create" method="post" enctype="multipart/form-data">
            ...
            <div class="grid-padding-x grid-x">
                    ...
                    <div class="small-12 cell">
                        ...
                        <input class="button success float-right" type="submit" value="Create Product">
                    </div>
