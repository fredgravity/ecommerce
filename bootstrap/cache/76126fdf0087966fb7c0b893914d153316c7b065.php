<?php $__env->startSection('title', 'Vendor Revenue Dashboard'); ?>
<?php $__env->startSection('data-page-id', 'revenueDashboard'); ?>

<?php $__env->startSection('content'); ?>

    <div class="admin_shared payment dashboard grid-container full" id="vendor-revenue">
                    ...
                    <div class="card-section">
                        <div class="grid-padding-x grid-x">
                            ...
                            <div class="small-9 cell">
                                <p>Cedis</p><h4 id="vendor-revenue-cedis" ><?php echo e(number_format($revenue, 2)); ?></h4>
                            </div>
                        </div>
