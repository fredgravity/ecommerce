<?php $__env->startSection('title', 'User Payment'); ?>
<?php $__env->startSection('data-page-id', 'userPayment'); ?>
                    ...
                    <div class="card-section">
                        <div class="grid-x grid-padding-x">
                            ...
                            <div class="small-9 cell">
                                <p>Cedis</p><h4 id="userPayment-cedis" ><?php echo e(number_format($revenue, 2)); ?></h4>
                            </div>
                        </div>
