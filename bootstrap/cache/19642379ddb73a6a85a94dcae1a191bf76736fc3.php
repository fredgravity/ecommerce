<?php $__env->startSection('title', 'Vendor Edit Product'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="add-product admin_shared grid-container full">
        ...
        <form action="/vendor/product/<?php echo e($products->id); ?>/productEdit" method="post" enctype="multipart/form-data">
                ...
                <table data-form="deleteForm">
                    <tr style="border-style: hidden !important;">
                        <td style="border-style: hidden !important;">
                            <form action="/vendor/product/<?php echo e($products->id); ?>/delete" method="post" class="delete-item">
                                <input type="hidden" name="token" value="<?php echo e(\App\Classes\CSRFToken::generate()); ?>">
